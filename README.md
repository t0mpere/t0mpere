...
#### PRs
- Adding aggregationConfigs example to starTreeIndexConfigs [#258](https://github.com/pinot-contrib/pinot-docs/pull/258)
- Note on `noDictionary` compression for metrics columns in forward-index.md [#244](https://github.com/pinot-contrib/pinot-docs/pull/244)
- Hint to avoid having too many files in inputDirURI [#178](https://github.com/pinot-contrib/pinot-docs/pull/178)
